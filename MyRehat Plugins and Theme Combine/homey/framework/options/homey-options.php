...
Redux::setSection( $opt_name, array(
    ...
    'fields'        => array(
        ...
        Add Listing for Final Promotion

        --------------------*/

        array(
            'id'       => 'enable_last_day_discount',
            'type'     => 'switch',
            'title'    => esc_html__('Last Day Promotion', 'homey' ),
            'desc'     => esc_html__( 'Enable/Disable Last Day Promotion Pricing', 'homey' ),
            'default'  => 0,
            'on'       => esc_html__( 'Enabled', 'homey' ),
            'off'      => esc_html__( 'Disabled', 'homey' ),
        ),
        ...
        array(
            'id'       => 'listing_list_last_day_discount',
            'type'     => 'select',
            'multi'    => true,
            'title'    => __('Listing Lists', 'homey'),
            'desc' => __('You can select multiple listings', 'homey'),
            'subtitle'     => '',
            'required' => array('enable_last_day_discount', '=', '1'),
            'options' => array_combine($all_post_ids, $all_post_ids),
            
        ),

        array(
            'id'       => 'last_day_discount',
            'type'     => 'text',
            'title'    => esc_html__('Amount', 'homey' ),
            'subtitle'     => '',
            'desc' => esc_html__('Enter the Last Day Price. Only number', 'homey'),
            'required' => array('enable_last_day_discount', '=', '1'),
            'default' => '',
        ),

        array(
            'id'       => 'listing_list_last_day_discount_start_date',
            'type'     => 'date',
            'title'    => __('Start Date', 'homey'),
            'desc'     => __('Select the start date for the last day discount', 'homey'),
            'subtitle' => '',
            'required' => array('enable_last_day_discount', '=', '1'),
            'format'   => 'dd-mm-yy'
        ),
        ...
        array(
            'id'       => 'listing_list_last_day_discount_end_date',
            'type'     => 'date',
            'title'    => __('End Date', 'homey'),
            'desc'     => __('Select the end date for the last day discount', 'homey'),
            'subtitle' => '',
            'required' => array('enable_last_day_discount', '=', '1'),
            'format'   => 'dd-mm-yy'
        ),
...
Redux::setSection( $opt_name, array(
    'title'  => esc_html__( 'Reservation For Listings', 'homey' ),
    'id'     => 'email-reservation',
    'desc'   => esc_html__('Global variables {reservation_detail_url}, {guest_message}, {message_link}, {check_out}, {check_in}, {price}, {name_guest}, {phone_number}, {email_address}, {adults}, {children} {owner_name}, {owner_phone_number}, {owner_email}, {listing_title}, {listing_id}', 'homey' ),
    'icon'   => '',
    'subsection' => true,
    'fields'    => array(
        array(
...
Redux::setSection( $opt_name, array(
    'title'  => esc_html__( 'Reservation for Experiences', 'homey' ),
    'id'     => 'email-exp-reservation',
    'desc'   => esc_html__('Global variables {reservation_detail_url}, {guest_message}, {message_link}, {check-in}, {price}, {name_guest}, {phone_number}, {email_address}, {guests}, {owner_email}, {owner_number} {owner_name}, {experience_title}, {experience_id}', 'homey' ),
    'icon'   => '',
    'subsection' => true,
    'fields'    => array(
        array(
        ...
        array(
            'id'       => 'homey_subject_new_exp_reservation',
            'type'     => 'text',
            'title'    => esc_html__('Email Subject', 'homey'),
            'desc'     => esc_html__('Enter the email subject', 'homey'),
            'default'  => esc_html__('New Reservation Request at {site_title}', 'homey'),
...
<p><strong>Guest Message:</strong> {guest_message}&nbsp;<a href="{message_link}">click for reply</a><br /><br />Confirm Availability <a href="{reservation_detail_url}">Confirm</a><br /><br />Thank you for choosing Homey!<br />Homey Team.</p>',
        ...
        array(
            'id'       => 'homey_subject_new_exp_reservation_sent',
            'type'     => 'text',
            'title'    => esc_html__('Email Subject', 'homey'),
            'desc'     => esc_html__('Enter the email subject', 'homey'),
            'default'  => esc_html__('Your Reservation Request Sent to {site_title}', 'homey'),
        ...
        array(
            'id'       => 'homey_new_exp_reservation_sent',
            'type'     => 'editor',
            'title'    => esc_html__('Email Content', 'homey'),
            'default'  => '<p><strong>Thank You!</strong> Your reservation is sent to {site_title}.</p>
<p><strong>Your Message:</strong> {guest_message}&nbsp;<a href="{message_link}">click to send another message</a><br /><br /> for details <a href="{reservation_detail_url}">Click here</a><br /><br />Thank you for choosing Homey!<br />Homey Team.</p>',
        ...
        array(
            'id'       => 'homey_subject_confirm_exp_reservation',
            'type'     => 'text',
            'title'    => esc_html__('Email Subject', 'homey'),
            'desc'     => esc_html__('Enter the email subject', 'homey'),
            'default'  => esc_html__('Reservation Confirmed on {site_title}', 'homey'),
        ...
        array(
            'id'       => 'homey_confirm_exp_reservation',
            'type'     => 'editor',
            'title'    => esc_html__('Email Content', 'homey'),
            'default'  => 'So far so good! Host confirmed availability for your reservation.<br>
Complete the payment due <a href="{reservation_detail_url}">Pay Now</a><br>
...
Homey Team.',
        ...
        array(
            'id'       => 'homey_subject_booked_exp_reservation',
            'type'     => 'text',
            'title'    => esc_html__('Email Subject', 'homey'),
            'desc'     => esc_html__('Enter the email subject', 'homey'),
            'default'  => esc_html__('Reservation Booked on {site_title}', 'homey'),
        ...
        array(
            'id'       => 'homey_booked_exp_reservation',
            'type'     => 'editor',
            'title'    => esc_html__('Email Content', 'homey'),
            'default'  => 'Well done! Payment received the reservation has been booked.<br>
View detail by clicking <a href="{reservation_detail_url}">here</a><br>
...
Homey Team.',
        ...
        array(
            'id'       => 'homey_subject_admin_booked_exp_reservation',
            'type'     => 'text',
            'title'    => esc_html__('Email Subject', 'homey'),
            'desc'     => esc_html__('Enter the email subject', 'homey'),
            'default'  => esc_html__('Reservation Booked on {site_title}', 'homey'),
        ...
        array(
            'id'       => 'homey_admin_booked_exp_reservation',
            'type'     => 'editor',
            'title'    => esc_html__('Email Content', 'homey'),
            'default'  => 'Congratulations! The reservation has been booked.<br>
View detail by clicking <a href="{reservation_detail_url}">here</a><br>
...
Homey Team.',
        ...
        array(
            'id'       => 'homey_subject_declined_exp_reservation',
            'type'     => 'text',
            'title'    => esc_html__('Email Subject', 'homey'),
            'desc'     => esc_html__('Enter the email subject', 'homey'),
            'default'  => esc_html__('Reservation Declined on {site_title}', 'homey'),
        ...
        array(
            'id'       => 'homey_declined_exp_reservation',
            'type'     => 'editor',
            'title'    => esc_html__('Email Content', 'homey'),
            'default'  => 'Your reservation has been declined by the host<br>
View detail by clicking <a href="{reservation_detail_url}">here</a><br>
...
Homey Team.',
        ...
        array(
            'id'       => 'homey_subject_cancelled_exp_reservation',
            'type'     => 'text',
            'title'    => esc_html__('Email Subject', 'homey'),
            'desc'     => esc_html__('Enter the email subject', 'homey'),
            'default'  => esc_html__('Reservation Cancelled on {site_title}', 'homey'),
        ...
        array(
            'id'       => 'homey_cancelled_exp_reservation',
            'type'     => 'editor',
            'title'    => esc_html__('Email Content', 'homey'),
            'default'  => 'The reservation has been cancelled<br>
View detail by clicking <a href="{reservation_detail_url}">here</a><br>
...
Homey Team.',
        ...
        array(
            'id'       => 'homey_subject_guest_sent_payment_exp_reservation',
            'type'     => 'text',
            'title'    => esc_html__('Email Subject', 'homey'),
            'desc'     => esc_html__('Enter the email subject', 'homey'),
            'default'  => esc_html__('Reservation Payment {site_title}', 'homey'),
        ...
        array(
            'id'       => 'homey_guest_sent_payment_exp_reservation',
            'type'     => 'editor',
            'title'    => esc_html__('Email Content', 'homey'),
            'default'  => 'Guest made reservation payment, verify it and mark reservation as booked<br>
View detail by clicking <a href="{reservation_detail_url}">here</a><br>
...
Homey Team.',
        ...
        array(
            'id'       => 'homey_subject_guest_sent_payment_exp_reserv_guest',
            'type'     => 'text',
            'title'    => esc_html__('Email Subject', 'homey'),
            'desc'     => esc_html__('Enter the email subject', 'homey'),
            'default'  => esc_html__('Reservation Payment {site_title}', 'homey'),
        ...
        array(
            'id'       => 'homey_guest_sent_payment_exp_reserv_guest',
            'type'     => 'editor',
            'title'    => esc_html__('Email Content', 'homey'),
            'default'  => 'You made reservation payment, admin will verify it and mark reservation as booked<br>
View detail by clicking <a href="{reservation_detail_url}">here</a><br>
...
// Added New section for Email in Experiences.
