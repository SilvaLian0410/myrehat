        ...
        <form autocomplete="off" id="submit_experience_form" name="new_post" method="post" action="#" enctype="multipart/form-data" class="edit-frontend-property">
            ...
            <div class="block">
                <div class="block-head table-block">
                    ...
                    <h2 class="title" id ="uploading" style="font-size:18px; color:#ef3e35; display: none;">Your experience is being uploaded. Please do not leave the site. Uploading may depend on the information provided.</h2>
                ...
                <div class="listing-submit-wrap">
                    ...
                    if($post_status != 'pending' || homey_is_admin()) {
                        ...
                        <?php } else { ?>
                            <button class="btn btn-dark-grey btn-save-experience" id = "popupButton" style = "width:100%"><?php echo esc_attr($homey_local['update_btn']); ?></button>
                            <script>
                              var button = document.getElementById("popupButton");
                              var messege = document.getElementById("uploading");
