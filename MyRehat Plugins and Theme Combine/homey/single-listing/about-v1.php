...
$kiblaturl = 'https://myrehat.com/wp-content/uploads/2023/09/kiblat.png';
$sejadahurl = 'https://myrehat.com/wp-content/uploads/2023/09/sejadah.png';
$quranurl = 'https://myrehat.com/wp-content/uploads/2023/09/quran.png';

$muslim_kiblat = '<i><img src="' .$kiblaturl . '" class="homey-icon "></i>';
$muslim_sejadah = '<i><img src="' . $sejadahurl . '" class="homey-icon"></i>'; 
$muslim_quran = '<i><img src="' . $quranurl . '" class="homey-icon"></i>'; 
...
if($icon_type == 'fontawesome_icon') {
    ...
    $muslim_icon = '<i class="'.esc_attr(homey_option('de_bathroom_icon')).'"></i>';
    ...
    $muslim_icon = '<img src="'.esc_url(homey_option( 'de_cus_bathroom_icon', false, 'url' )).'" alt="'.esc_attr__('bathroom_icon', 'homey').'">';
}
?>
<div id="about-section" data-issue="this-is-test" class="about-section version-1">
	
	<?php echo do_shortcode('[elementor-template id="33449"]'); ?>
    ...
    ?>
        <div class="block-bordered">
            <?php if($hide_labels['sn_type_label'] != 1 && $listing_type != '') { ?>
                <div class="block-col block-col-25">
                    <div class="block-icon">
                    <?php echo '<span class="muslim-quran-icon"></span>'; ?>
                    </div>
                </div>
            <?php } ?>
            ...
            <?php if($hide_labels['sn_accom_label'] != 1 && $guests != '') { ?>
                <div class="block-col block-col-25">
                    <div class="block-icon">
                    <?php echo '<span class="muslim-kiblat-icon"></span>'; ?>
                    </div>
                </div>
            <?php } ?>
            ...
            <?php if($hide_labels['sn_bedrooms_label'] != 1 && $bedrooms != '') { ?>
                <div class="block-col block-col-25">
                    <div class="block-icon">
                    <?php echo '<span class="muslim-sejadah-icon"></span>'; ?>
                    </div>
                </div>
            <?php } ?>
    ...
    <?php if($hide_labels['sn_about_listing_title'] != 1) { ?>
        <div class="block">
          <?php if ($muslim != '') { ?>
                ...
                <h4 style = "text-align: center;">This unit is Muslim-friendly</h4>
                <p style = "text-align: center;">The Quran, Sejadah (prayer mat) and Kiblat signage are provided. Kindly treat all amenities with respect.</p>
                </div>
    <?php } ?>
